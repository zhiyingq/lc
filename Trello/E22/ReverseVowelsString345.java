...
class ReverseVowelsString345 {
    ...
    */
    ...
    public String reverseVowels(String s) {
    	...
    	char[] chars = s.toCharArray();
    	while (start <= end) {
    		while (!vowels.contains(chars[start] + "")) { start++; }
    		while (!vowels.contains(chars[end] + "")) { end--; }
    ...
    public static void main(String[] args) {
    	ReverseVowelsString345 r = new ReverseVowelsString345();
